  ...
  return (
    <div data-aos="fade-up">
      ...
      >
        ...
        <p className="font-serif text-xl font-bold text-blue1 tracking-wide group-hover:text-dark_blue transition-transform duration-500 transform  ">
          {capitalizeFirstLetter(title)}
        </p>
        <div className="font-inter text-xl font-semibold text-brown1 mt-2 transition-transform duration-500 transform">
          {price}
          <span>€</span>
        </div>
      </Link>
